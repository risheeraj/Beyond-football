...
def home(request):
    return render(request, 'beyond_football/home.html')


def about(request):
    return render(request, 'beyond_football/about.html')
...
def stats(request):
    ...
    return render(request, 'beyond_football/stats.html',context)
...
#     }]
#     context = {'search' : dic}
#     return render(request, 'beyond_football/   searchResult.html', context)
...
def register(request):
    if request.user.is_authenticated:
        ...
        context = {'form': form}
    return render(request, 'beyond_football/register.html', context)
...
def loginUser(request):
    if request.user.is_authenticated:
        ...
        context = {}
        return render(request, 'beyond_football/login.html', context)
...
def predictor(request):
    return render(request, 'beyond_football/predictor.html')
...
def prediction(request):
    ...
    return render(request, 'beyond_football/prediction.html', context)
...
# 1. Analysing players on the basis of preferred foot (Right or Left)
    ...
    # return render(request, 'beyond_football/analysis.html', {'data': uri})
...
# Analysis based on body weight of the players
   ...
   # 7. Analysing tball control and dribbling attri of left-footed and right-footed footballers
    ...
    plt.close('all')
    return render(request, 'beyond_football/analysis.html', {'data1': uri1, 'data2': uri2, 'data3': uri3, 'data4': uri4, 'data5': uri5,'data6':uri6 ,'data7': uri7,'data9':uri9,'data10':uri10,'data11':uri11 })
